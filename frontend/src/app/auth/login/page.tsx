...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex">
      {/* 左侧装饰区 */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary via-blue-500 to-cyan-500">
        {/* 装饰元素 */}
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          >
            ...
            <p className="mt-4 text-lg text-white/80 max-w-md leading-relaxed">
              登录你的账号，收藏心仪的项目，追踪报名进度，让保研之路更加从容。
            </p>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-2xl font-bold sm:text-3xl">登录账号</h1>
          ...
          <Card className="mt-8 border-0 shadow-none lg:border lg:shadow-sm lg:hover:shadow-md transition-shadow duration-300">
            <CardContent className="p-0 lg:p-6">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <Button
                  type="submit"
                  className="w-full h-11 text-base gap-2 transition-all hover:shadow-md hover:scale-[1.01] active:scale-[0.99]"
                  disabled={isLoading}
                >
                  {isLoading ? (
